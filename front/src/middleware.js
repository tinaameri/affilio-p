...
const redirects = {
  '/blog/what-is-ad-campaign': '/blog/post/کمپین_تبلیغاتی_چیست؟_نکات_مهم_در_راه%E2%80%8C%E2%80%8Cاندازی_یک_کمپین_تبلیغاتی',
  '/blog/sms-marketing': '/blog/post/بازاریابی_پیامکی_و_پیام%E2%80%8Cهای_متنی_موثر_برای_ارتباط_با_مشتری',
  ...
  '/blog/how-to-increase-online-sales/':`/blog/post/۱۰_نکته_برای_کمک_به_افزایش_فروش_آنلاین_`,  '/blog/what-is-competitive-advantage/' : `/blog/post/مزیت_رقابتی_در_بازار_به_چه_معناست؟`,
