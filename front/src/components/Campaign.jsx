...
export default function Campaign({heading_title, image_mobile,image_desktop}) {
    ...
    return (
        <Container bg="#FDFDFD" fluid='fluid' pb='xl'>
            <Layout>
                ...
                <Grid.Col sx={12} pos='relative' mih='300px' px={smallerSmallScreen && '100px'}>
                    <Image src={smallerSmallScreen ? image_mobile : image_desktop} width='100%' alt={heading_title} />
