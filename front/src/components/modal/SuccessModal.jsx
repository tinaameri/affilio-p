;
import { Grid, Container, Title, Text, NumberInput, Input, TextInput, Button, Box, Select, Textarea, Checkbox, Modal, Image, } from '@mantine/core';
...
export default function SuccessModal() {
    ...
    return (
        <Modal opened={modalOpenState.successModal} onClose={handleClose} centered size='xl' radius='25px'>
                ...
                <Box align='center'>
                    ...
                    <Box my='xl' >
                        <Text color='primary.1' fw='700'>
                            {textSplitter({ text: submission?.description, style: {pt : 'md'} })}
                        </Text>
                    </Box>
                    <Button bg='secondary.0' color='secondary.2' onClick={handleClose}>{submission?.ok}</Button>
                </Box>
            </Container>
        </Modal>
    )
