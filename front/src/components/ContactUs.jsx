...
export default function ContactUs({bg,img,description,buttonType,buttonTitle,buttonLink,targetBlank}) {
            ...
            <Layout align='flex-end' pt={largerScreen ? '100px' : '50px'}>
                <Grid.Col xs={12} md={12} lg={5} py='0' orderXs={1} orderLg={0} >
                    <Box pos='relative' h={largerScreen ? '250px' : '150px'} >
                        <Image src={img} width='100%' height={largerScreen ? '250px' : '140px'} alt='contact-us' fit='contain' />
                ...
                <Grid.Col xs={12} md={12} lg={7} pb={largerScreen ? '110px' : '20px'}>
                    ...
                    <ButtonComponent type={buttonType} href={buttonLink} title={buttonTitle} targetBlank={targetBlank} />
                </Grid.Col>
            </Layout>
