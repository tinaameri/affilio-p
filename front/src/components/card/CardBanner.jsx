import { Box, Text, Title, Grid, createStyles,Flex, Image } from '@mantine/core';
...
export default function CardBnanner({ title, description, src, image, bgColor, color, button, bgBtn, py, customers, lgWidth, xlWidth, image_height, wrapperBgColor, heading_description, heading_title, bgSection, bgBanner }) {
    ...
    return (
        <Box bg='#FDFDFD' mb={largerMidScreen && '100px'}>
            ...
            <Zoom>
                ...
                <Layout  className={`${classes.box}`} bgColor={largerMidScreen && bgBanner} my={largerMidScreen && '53px'} py='xl'>

                    <Grid.Col xs={12} sm={12} md={8} lg={6} xl={6} m='auto' >
                        <Flex align='center' pos='relative' px={largerMidScreen && 'md'} mih={largerMidScreen ? `${image_height}px` : '300px'}
                            w='100%'>
                            <Image
                                //layout='fill'
                                fit='contain'
                    ...
                    <Grid.Col xs={12} sm={12} md={12} lg={6}
                        m='auto' pb={largerMidScreen ? '0' : '100px'} px={largerMidScreen && 'md'} >
