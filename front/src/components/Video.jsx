...
export default function Video({ title,link, background,content,bgSection }) {
    return (
            ...
            <Layout>
                ...
                <Grid.Col xs={12} mt='xl'>
                    ...
                    <Box mih='400px'>
                        ...
                        >
                            <source src={`${IMAGES_BASE_UR}${content?.video?.data?.attributes?.url}`} type="video/mp4" style={{ borderRadius: '15px', border: 'unset', width: '100%', height: '500px' }}
                            />
                        </video>
                    </LazyLoad>
                    </Box>
