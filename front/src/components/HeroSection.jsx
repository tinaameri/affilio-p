...
export default function HeroSection(props) {
    ...
    const { topTitle, title, top_subtitle, subtitle, button, bgBtn, src, href, topTitleColor, bg, pyContent, titleColor, topSubtitleColor, subtitleColor, lottie, bgHover, btnColor, onClick, contentOrder, beforeSymbol, afterSymbol, link, buttonType, targetBlank,wordsAnimation } = props
    ...
    return (
        ...
        >
            ...
            // mt={smallerXsScreen ? '78px' : smallerLgScreen ? '90px' : '98px'}
            >
                <Grid.Col my='auto' xs={12} sm={12} md={12} lg={6} xl={6} h='100%' pt='xl' mx='0' px='0'
                ...
                >
                    ...
                    <Flex
                        ...
                        direction="column"
                        wrap="wrap"
                        mih={largerMidScreen ? '400px' : '300px'} h='auto'
                    // w='80%'
                    >
                        {topTitle && <Text fz={smallerXsScreen ? '14px' : '16px'} color='#000'
                        ...
                        {top_subtitle && <Text component='p' mt='xl' fw='700' fz={largerSmallScreen ? 'lg' : 'sm'} >{top_subtitle}</Text>}
                        {subtitle && <Text
                            mx={{ base: 'auto', lg: 'unset', xl: 'unset' }}
                            w={{ lg: '90%', md: "90%", sm: '78%', xs: '98%' }}
                            my={smallerXsScreen ? 'xs' : 'xl'} fz={largerSmallScreen ? 'lg' : 'sm'} >
                        ...
                        {button && <ButtonComponent type={buttonType} href={link} title={button} targetBlank={targetBlank} />}
                        {/* } */}
                    </Flex>
                </Grid.Col >
