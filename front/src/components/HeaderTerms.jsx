...
export default function HeaderTerms({ title, downloadLink }) {
    ...
    return (
        ...
        mt={smallerXsScreen ? '66px' : smallerLgScreen ? '80px' : '86px'}
            ...
            align="center"
            direction="column"
            wrap="wrap" h={largerSmallScreen ? '248px' : '187px'} bg='primary.7' py='xl'>
            <Title order={largerSmallScreen ? 1 : 2} ta='center' px='xs' color='primary.1'>{title}</Title>

            <Button  component='a' href={downloadLink} color='secondary.0' mt='xl' download>
