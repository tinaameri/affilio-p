...
export interface ApiConfigConfig extends Schema.SingleType {
  ...
  attributes: {
    ...
    Navigation: Attribute.Component<'page-element.nav-menu', true>;
    footerNavigation: Attribute.Component<'page-element.footer-links', true> &
      Attribute.SetMinMax<{
        max: 3;
      }>;
...
export interface ApiContactUsContactUs extends Schema.SingleType {
  ...
  attributes: {
    ...
    description: Attribute.RichText;
    info: Attribute.Component<'page-element.field-info', true>;
    title: Attribute.String;
...
export interface ApiStaticPageStaticPage extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    page_dynamic_sections: Attribute.DynamicZone<
      [
        ...
        'page-section.card-banner',
        'page-section.create-campaign',
